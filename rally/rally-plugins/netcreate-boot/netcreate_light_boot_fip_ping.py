...
class CreateNetworkLightBootPing(neutron_utils.NeutronScenario, vm_utils.VMScenario):
    ...
    def _schedule(self):
        ...
        hypervisors = {'overcloud-compute-0.localdomain': '192.168.24.11',
                       'overcloud-compute-1.localdomain': '192.168.24.7',
                       'overcloud-compute-2.localdomain': '192.168.24.10',
                       'overcloud-compute-3.localdomain': '192.168.24.9'}
